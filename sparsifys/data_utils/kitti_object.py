# @Time     : 2022/4/15 20:57
# @Author   : Chen nengzhen
# @FileName : kitti_object.py
# @Software : PyCharm
import os

# from sparsifys.data_utils import kitti_util as utils
from sparsifys.data_utils import kitti_util
...
class kitti_object(object):
    ...
    def get_image(self, idx):
        ...
        return kitti_util.load_image(img_filename)
    ...
    def get_lidar(self, idx):
        ...
        return kitti_util.load_velo_scan(lidar_filename)

    def get_calibration(self, idx):
        calib_filename = os.path.join(self.calib_dir, '%06d.txt' % idx)
        return kitti_util.Calibration(calib_filename)

    def get_label_objects(self, idx):
        label_filename = os.path.join(self.label_dir, '%06d.txt' % idx)
        return kitti_util.read_label(label_filename)
